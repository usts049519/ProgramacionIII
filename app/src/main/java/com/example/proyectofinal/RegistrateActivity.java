            ...
            public void onClick(View view) {
                ...
                if(!Nombre.isEmpty() && !Email.isEmpty() && !Password.isEmpty()){
                    if (Password.length() >= 6) {
                        ...
                        Toast.makeText(RegistrateActivity.this,"Debes elegir una contraseña de al menos 6 caracteres", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(RegistrateActivity.this,"Debes llenar todos los campos", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mAuth.createUserWithEmailAndPassword(Email, Password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(RegistrateActivity.this,"Tu correo ya esta registrado", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
